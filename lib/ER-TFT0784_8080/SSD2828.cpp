...
//-----------------------------------------------------------------------------
SSD2828::SSD2828(uint8_t CSp, uint8_t RSTp, uint8_t SDIp, uint8_t SCKp) {
    CS_2828 = CSp;
    RST_2828 = RSTp;
    SDI_2828 = SDIp;
    SCLK_2828 = SCKp;
...
void SSD2828::initialize(void) {
    ...
    SPI_WriteData(0x25);  // 14,D7-0=NS(0x01 : NS=1) //LL: was 0x20
    ...
    /*
      //This section was moved towards the end
      GP_COMMAD_PA(1);
      SPI_WriteData(0x11);
    //  delay(220);    //LL Exit Sleep
      GP_COMMAD_PA(1);
      SPI_WriteData(0x29);
    //  delay(220);    // LL Display ON
    */
    ...
    // this section was moved down here - better!
    GP_COMMAD_PA(1);
    SPI_WriteData(0x11);
    delay(120);  // LL Exit Sleep
    GP_COMMAD_PA(1);
    SPI_WriteData(0x29);
    delay(220);  // LL Display ON
